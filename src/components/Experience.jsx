        ...
        <div className="flex flex-col gap-16">
          {experiences.map((exp, i) => (
            ...
            >
              ...
              <div className="w-6 h-6 bg-orange-500 rounded-full border-4 border-dark z-10"></div>

              {/* Experience Card */}
              <motion.div
                className="w-1/2 bg-gray-800 p-6 rounded-lg shadow-md border border-white/10"
                whileHover={{
