...
function HeroSection() {
  ...
  return (
    <section
      ...
      className="w-full flex-col bg-dark h-270 flex px-10 md:px-25 pt-10 scroll-mt-24 overflow-hidden relative md:flex-row md:h-screen"
    >
      ...
      <div className="left-section text-center items-center overflow-hidden md:items-start flex flex-col gap-8 w-full md:w-1/2 md:text-left">
        ...
        <div className="absolute inset-0 bg-amber-300/30 z-0 w-70 lg:w-100 rounded-full mx-20 md:mx-30 mt-10 h-2/5 blur-3xl md:ml-20 md:h-3/5"></div>
        ...
        <motion.h1
          ...
          animate="visible"
          viewport={{ once: false, amount: 0.3 }}
          className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent"
        >
